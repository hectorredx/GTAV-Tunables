module.exports = {
    ...
    TUNABLE_CONTEXTS: ['BASE_GLOBALS', 'MP_Global', 'CD_GLOBAL', 'MP_CNC', 'MP_CNC_TEAM_COP', 'MP_CNC_TEAM_VAGOS', 'MP_CNC_TEAM_LOST', 'MP_FM', 'MP_FM_MEMBERSHIP', 'MP_FM_DM', 'MP_FM_RACES', 'MP_FM_RACES_CAR', 'MP_FM_RACES_BIKE', 'MP_FM_RACES_CYCLE', 'MP_FM_RACES_AIR', 'MP_FM_RACES_SEA', 'MP_FM_RACES_STUNT', 'MP_FM_MISSIONS', 'MP_FM_SURVIVAL', 'MP_FM_BASEJUMP', 'MP_FM_CAPTURE', 'MP_FM_LTS', 'MP_FM_HEIST', 'MP_FM_CONTACT', 'MP_FM_RANDOM', 'MP_FM_VERSUS', 'MP_FM_GANG_ATTACK', 'MP_FMADVERSARY', 'CONTENT_MODIFIER_0', 'CONTENT_MODIFIER_1', 'CONTENT_MODIFIER_2', 'CONTENT_MODIFIER_3', 'CONTENT_MODIFIER_MEMBERSHIP_0', 'CONTENT_MODIFIER_MEMBERSHIP_1', 'CONTENT_MODIFIER_MEMBERSHIP_2', 'CONTENT_MODIFIER_MEMBERSHIP_3', 'CONTENT_MODIFIER_MEMBERSHIP_4'],
};
